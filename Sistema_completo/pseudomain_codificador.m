...
%==================================================================
pkg load signal;
[xn,Fs]= audioread("WhosTheMonkey.wav");

%==================================================================
%     se aplica el primer filtrado
%==================================================================
[dec_L,dec_H]=filter_decimator(xn);
...
%==================================================================
[dec_4_L,dec_3_H]=filter_decimator(dec_L);
%5dec_4_L = pasa_bajas_decimada;		%Decimación para el pasa bajas;
%dec_3_H = pasa_altas_decimada;  %Decimación para el pasa altas


[dec_2_L,dec_1_H]=filter_decimator(dec_H);
